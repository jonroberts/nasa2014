...
Crafty.scene('Intro', function() {
	...
	+ "<h3>How to play</h3>"
	+ "<p><strong>Probing asteroids:</strong> Send out probes to determine the valuable minerals in an asteroid. Manuver your probe to collide with an asteroid and then mouse over it. It will tell you the most valuable mineral (water/ice, metals, hydrogen, platinum or none).<br>"
	+ "<strong>Mining asteroids:</strong> Purchase an asteroid miner (After researching it in your research tree) and then manuver it to the asteroid you'd like to mine. Remember that in the beginning, you will only be able to mine asteroids with water/ice. The mined asteroid will disapear and be added to your ships cargo. Then return your ship to the launch location to collect the reward.<br>"
	+ "<strong>Upgrades:</strong> In your research tree, you can purchase upgrades. Upgrades will allow you to mine more asteroid types (Metals and hydrogen) as well as more easily identify the valuable minerals in asteroids.<br>"
	+ "<strong>Winning:</strong> To win the game, you must build the Orbiting Asteroid Defense Platform. This will require you to build all the necessary mining and production upgrades in your research tree.</p>"
